...
6. [Progress tracking](progress-tracking.md) — charts & what's measured
7. [AI providers](ai-providers.md) — the fallback chain & running with no key
8. [Data & storage](data-and-storage.md) — what's stored, where, and backups
