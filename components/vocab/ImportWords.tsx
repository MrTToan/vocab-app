...
/**
 * Bulk CSV importer: paste or upload a CSV, map its columns, preview, and import
 * in chunks with optional per-word enrichment. Server-side dedupe skips words
 * already in the library. Extracted from the old /import page so it can share
 * the combined Add page with the single-word add flow.
 */
